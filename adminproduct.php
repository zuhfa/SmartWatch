...
.display-product-table table td button{
   background-color: #d3675b;
   padding:5px 15px 5px 15px;
   border-radius: 10px;
}
.display-product-table table td button:hover{
      ...
      <tbody>
         ...
         <tr>
            ...
            <td>
               ...
               <a href="adminproduct.php?edit=<?php echo $row['id']; ?>" class="option-btn"> <i class="fas fa-edit"></i> update </a>
            </td>
         </tr>
